      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
          ...
          <div className="lg:col-span-1 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 gap-4">
            <div className="bg-white rounded-2xl p-6 border border-slate-100 hover:border-accent-200 hover:shadow-md transition-all">
              <div className="w-10 h-10 bg-accent-100 rounded-full flex items-center justify-center text-xl mb-4">
                🎓
              </div>
          ...
          <div className="lg:col-span-2 bg-white rounded-2xl p-8 border border-slate-100">
            ...
            <ul className="space-y-3">
              {professionalPrograms.map((p, i) => (
                <li key={i} className="flex items-start gap-3">
                  <span className="w-6 h-6 rounded-full bg-accent-50 border border-accent-200 text-accent-700 font-bold text-xs flex items-center justify-center flex-shrink-0 mt-0.5">
                    {i + 1}
                  </span>
            ...
            <a
              href="#programs"
              className="inline-block mt-6 text-accent-600 font-semibold text-sm hover:text-accent-700 transition-colors"
            >
