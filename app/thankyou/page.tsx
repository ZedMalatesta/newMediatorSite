      ...
      <main>
        <section className="px-4 py-24 md:py-32 bg-white text-center">
          <div className="max-w-xl mx-auto">
            <span className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-amber-100 text-amber-600 mb-6">
            ...
            <a
              ...
              className="inline-block mt-6 bg-amber-500 text-white px-8 py-3 rounded-lg font-semibold hover:bg-amber-400 transition-colors"
            >
              Перейти в Telegram
            </a>
          </div>
