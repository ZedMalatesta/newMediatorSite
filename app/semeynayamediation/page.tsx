  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <main>
        ...
        <EventDetails
          description={[
            "Курс охватывает этапы развода, техники психологической поддержки и стратегии совместного родительства.",
          ]}
          groups={[
            {
              heading: "Для кого",
              items: ["Семейные медиаторы, психологи, социальные работники, юристы, терапевты"],
            },
          ]}
          speaker={{
            name: "Оксана Шульга",
