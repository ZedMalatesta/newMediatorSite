export default function TopBar() {
  return (
    <div className="bg-slate-800 border-b border-amber-500/20 text-white text-sm">
      <div className="max-w-6xl mx-auto px-4 py-2 flex flex-col sm:flex-row items-center justify-between gap-2">
        <div className="flex items-center gap-4 text-slate-300">
          ...
          <a href="tel:+375336899019" className="hidden sm:block hover:text-amber-400 transition-colors">
            +375 (33) 689‑90‑19
          </a>
        ...
        <div className="flex items-center gap-4">
          ...
          <a
            href="#footer"
            className="bg-amber-500 text-white px-3 py-0.5 rounded text-xs font-semibold hover:bg-amber-400 transition-colors"
          >
            Записаться
          </a>
        </div>
